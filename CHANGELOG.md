...
* **ci:** harden validator release dependencies ([#40](https://github.com/flowcore-io/usable-pr-validator/issues/40)) ([142962c](https://github.com/flowcore-io/usable-pr-validator/commit/142962c00fc71e149d48a2f4869e61cc22791ea9))

## [2.2.3](https://github.com/flowcore-io/usable-pr-validator/compare/v2.2.2...v2.2.3) (2026-08-12)


### Bug Fixes

* **ci:** pin the OpenCode installer ([0cf96d3](https://github.com/flowcore-io/usable-pr-validator/commit/0cf96d358c8e65126401f58fdd25c7b2a1abe065))

## [2.2.2](https://github.com/flowcore-io/usable-pr-validator/compare/v2.2.1...v2.2.2) (2026-06-10)


### Bug Fixes

* pass prompt via stdin to avoid "Argument list too long" on large PRs ([#35](https://github.com/flowcore-io/usable-pr-validator/issues/35)) ([9618150](https://github.com/flowcore-io/usable-pr-validator/commit/961815053240e71082be8dbb149d6cf5ce9aea62))

## [2.2.1](https://github.com/flowcore-io/usable-pr-validator/compare/v2.2.0...v2.2.1) (2026-05-19)


### Bug Fixes

* Paths in README were wrong ([8a3d171](https://github.com/flowcore-io/usable-pr-validator/commit/8a3d171b3cf571138a8946d06af44bcb3710c619))
* Paths in README were wrong ([6f58789](https://github.com/flowcore-io/usable-pr-validator/commit/6f5878958fa07c1fdc1a33d165bb0b2e8caccadf))
...
* update OpenCode CLI installation URL to use the official site ([e5f5c02](https://github.com/flowcore-io/usable-pr-validator/commit/e5f5c0270185bae79ceb8f88d41cfad754bdfbe2))
* update OpenCode CLI installation URL to use the official site ([d3caf38](https://github.com/flowcore-io/usable-pr-validator/commit/d3caf38e43596c4887be586d25ea36c515144bef))
...
* add quiet flag to OpenCode CLI command in validation script ([87d7c6b](https://github.com/flowcore-io/usable-pr-validator/commit/87d7c6b1c55958d330d7655d172b7cd5103813d7))

## [2.0.2](https://github.com/flowcore-io/usable-pr-validator/compare/v2.0.1...v2.0.2) (2026-02-10)


### Bug Fixes

* update OpenCode CLI command to use prompt flag ([9f0305f](https://github.com/flowcore-io/usable-pr-validator/commit/9f0305f3ed55bc4e4d62144a92d7a91ee2343e21))

## [2.0.1](https://github.com/flowcore-io/usable-pr-validator/compare/v2.0.0...v2.0.1) (2026-02-10)


### Bug Fixes

* improve OpenCode CLI installation path handling in setup script ([99e1787](https://github.com/flowcore-io/usable-pr-validator/commit/99e1787bfde6f0b4d41ccc9e589fa8b5e02be7be))
* improve OpenCode CLI installation path handling in setup script ([cc5c43b](https://github.com/flowcore-io/usable-pr-validator/commit/cc5c43b5487f6e102b5597629d6420eabf743698))
